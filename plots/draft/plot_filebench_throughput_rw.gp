...
plot newhistogram, \
      ARG1 index 0 using 2:3:xtic(1)  lc rgbcolor "black" lw 2 lt -1 fs pattern 1
...
plot newhistogram, \
      ARG1 index 1 using 2:3:xtic(1)  lc rgbcolor "black" lw 2 lt -1 fs pattern 1
...
plot newhistogram, \
      ARG1 index 2 using 2:3:xtic(1)  lc rgbcolor "black" lw 2 lt -1 fs pattern 1
...
plot newhistogram, \
      ARG1 index 3 using 2:3:xtic(1)  lc rgbcolor "black" lw 2 lt -1 fs pattern 1
