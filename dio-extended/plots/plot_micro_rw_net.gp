...
set ylabel "{/:Bold {/:Italic Network usage (MiB/sec)}}" font ", 20" offset 0,-0.5
# set format y '%.s %c'
set format y "%.b"
set grid ytics
...
set rmargin 29
set bmargin 7.3
set xlabel "{/:Bold Sysdig (ES)}" font ", 20" offset 0,18.5,1
...
unset key
set bmargin 7.3
set key at screen 0.5, 0.035 center vertical height 1  maxrows 1 sample 2 font ", 20"
set xlabel "{/:Bold DIO (ES)}" font ", 20" offset 0,18.5,1
