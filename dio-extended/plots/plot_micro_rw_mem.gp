...
set output "graphs/micro_rw_mem.eps"
...
set ylabel "{/:Bold {/:Italic Memory usage (GiB)}}" font "NewsGotT, 22" offset -0.85,0
# set format y '%.s %c'
set format y "%.b"
set grid ytics
...
set ytics nomirror
set xtics nomirror rotate by 40 right font "NewsGotT, 22"
...
set bmargin 9
set key at screen 0.5, 0.035 center vertical height 1  maxrows 1 sample 2 font "NewsGotT, 22"
