...
set ylabel "{/:Bold {/:Italic Memory usage (GiB)}}" font ", 28" offset 1,0
set ytics font ", 30"
...
set xlabel "{/:Bold {/:Italic RingBuffer size (MiB)}}" font ", 28" offset 0,0.7,0
set xtics font ", 30"
...
plot ARG1 index 0 u 4 ti col lc rgbcolor "black" lw 2,\
    "" index 0 u 6 ti col axes x1y1 lw 2 lt -1 fs pattern 1, \
    "" index 0 u 7 ti col axes x1y1 lw 2 lt -1 fs pattern 8,\
