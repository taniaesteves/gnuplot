...
set xlabel "{/:Bold {/:Italic Batch size (MiB)}}" font "NewsGotT, 30" offset 0,0.7,0

set bmargin 5.8
set lmargin 7.5
set rmargin 0.5

set key at screen 0.56, 0.04 center vertical height 1  maxrows 1 sample 2 font "NewsGotT, 30"
